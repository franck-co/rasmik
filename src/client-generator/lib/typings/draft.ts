import type { ExpandProperty, HasCompositePk, PkKeys, Primary, RootEntity, ScalarKey, RelationKey, NotUndefined } from './utility'
...
export type DraftData<E extends RootEntity, Def extends DraftDef<E>, Arr = {}> = Arr extends Array<any> ? Array<DraftDataItem<E, Def>> : DraftDataItem<E, Def>
